...
export default function Navbar({ darkMode, setDarkMode, streak }) {
  return (
    <nav className="navbar">
      <div className="nav-logo">Plant<span className="accent">ID</span></div>
      ...
      <div className="nav-actions">
        {streak > 0 && <div className="streak-badge">🔥 {streak} scans</div>}
